        ...
        Box(
            ...
            Column(
                ...
                UnitTextField(
                    ...
                    onValueChange = { onEvent(NutrientGoalEvent.CarbsChange(it)) },
                    unit = stringResource(id = R.string.percent_carbs)
                )
                Spacer(modifier = Modifier.height(spacing.spaceMedium))
                UnitTextField(
                    value = uiState.proteinRatio,
                    onValueChange = { onEvent(NutrientGoalEvent.ProteinChange(it)) },
                    unit = stringResource(id = R.string.percent_proteins)
                )
                Spacer(modifier = Modifier.height(spacing.spaceMedium))
                UnitTextField(
                    value = uiState.fatRatio,
                    onValueChange = { onEvent(NutrientGoalEvent.FatChange(it)) },
                    unit = stringResource(id = R.string.percent_fats)
                )
            }
            ActionButton(
                text = stringResource(id = R.string.next),
                onClick = { onEvent(NutrientGoalEvent.NextClick) },
                modifier = Modifier
